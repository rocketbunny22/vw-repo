    ...
    <div className="flex flex-col">
      ...
      <section className="border-b border-vw-gold/35 bg-[linear-gradient(135deg,var(--vw-dark),var(--vw-blue))] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="max-w-4xl text-xl leading-relaxed text-vw-steel">{systemInfo.description}</p>
        </div>
      </section>
      ...
      {selectedGen && systemInfo.commonIssues && systemInfo.commonIssues.length > 0 && (
        <section className="border-b border-vw-line bg-vw-cream py-12">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="mb-4 text-2xl font-bold text-vw-red">Common Issues</h2>
      ...
      {selectedGen && systemInfo.maintenanceTips && systemInfo.maintenanceTips.length > 0 && (
        <section className="border-b border-vw-line bg-vw-surface py-12">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="mb-4 text-2xl font-bold text-vw-blue">Maintenance Tips</h2>
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-1 line-clamp-2 text-vw-muted">{sys.description}</p>
                    </div>
